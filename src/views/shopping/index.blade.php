    ...
    <div class="main_lay_cont">
        ...
        <div class="row layouts_row">
            <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 items_links">
                <a href="{!! route('payments_sopping_cart_general') !!}" class="ly_items">
                    <h3>General</h3>
                    <h2><i class="fa fa-columns" aria-hidden="true"></i></h2>
                </a>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 items_links">
                <a href="{!! route('payments_sopping_cart_zones') !!}" class="ly_items">
                    <h3>Zones</h3>
                    <h2><i class="fa fa-television" aria-hidden="true"></i></h2>
                </a>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 items_links">
                <a href="{!! route('payments_sopping_cart_methods') !!}" class="ly_items">
                    <h3>Methods</h3>
                    <h2><i class="fa fa-television" aria-hidden="true"></i></h2>
                </a>
            </div>
