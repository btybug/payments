...
class DataTablesConroller extends Controller
{
    ...
    public function getOrders()
    {
        return DataTables::of(Orders::query())->addColumn('actions', function ($attr) {
            ...
            $html = '<a href="' . route('edit_order', $order->id) . '" class="btn btn-warning"><i class="fa fa-edit"></i>Edit</a><a href="' . route('view_order', $order->id) . '" class="btn btn-info"><i class="fa fa-eye"></i>View</a>';
            return $html;
