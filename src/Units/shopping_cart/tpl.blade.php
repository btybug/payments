            ...
            @if(Cart::count())
                @foreach(Cart::content() as $item)
                    <div class="product">
                        ...
                        <div class="product-discount {{isset($settings['option_6_container_item_style']) ? $settings['option_6_container_item_style'] : ''}} {{isset($settings['option_7_container_item_style']) ? $settings['option_7_container_item_style'] : ''}}">
                            0%
                        </div>
